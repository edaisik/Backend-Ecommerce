...
import com.workintech.ecommerce.dto.product.CategoryRequest;
import com.workintech.ecommerce.dto.product.CategoryResponse;
import com.workintech.ecommerce.dto.product.ProductRequest;
...
public class Converter {
    ...
    public static ProductResponse productConverter(Product product) {
        return new ProductResponse(product.getId(), product.getName(), product.getImages(), product.getDescription(), product.getPrice(), product.getRating(), product.getSellCount(), product.getStock(), product.getCategory().getId());
    }

    public static Product productConverter(ProductRequest productRequest, Category category) {
